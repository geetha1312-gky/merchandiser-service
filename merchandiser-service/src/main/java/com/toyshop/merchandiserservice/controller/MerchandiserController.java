...
public class MerchandiserController {
    ...
    public MerchandiserController(MerchandiserService service){ this.service = service; }
    @GetMapping public List<Merchandiser> getAll(){ return service.getAllMerchandisers(); }
    @PostMapping public Merchandiser create(@RequestBody Merchandiser merchandiser){ return service.save(merchandiser); }
}
